 ...
 * Certificates: the JVM trust store, or the server certificate given with the call (PEM, pinned) - see {@link Tls}.
 */
public final class ProcessCenterExport {
    ...
    public static Map<String, Object> export(String baseUrl, String user, String password, String snapshotId, File target) throws IOException { return export(baseUrl, user, password, snapshotId, target, ""); }
    /** @param certificate the server certificate to trust (PEM), empty for the JVM trust store */
    public static Map<String, Object> export(String baseUrl, String user, String password, String snapshotId, File target, String certificate) throws IOException {
        ...
        Session s = new Session(certificate);
    ...
    static final class Session {
        final Map<String, String> cookies = new LinkedHashMap<>(); final String certificate;
        Session(String certificate) { this.certificate = certificate; }
        HttpURLConnection request(String method, String url, String form) throws IOException {
            HttpURLConnection c = (HttpURLConnection) new URL(url).openConnection();
            Tls.apply(c, certificate);
